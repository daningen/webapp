...
var menuView = (   function () {
    ...
    var topMenu = (function (newLink) {
        console.log("in menuView.topMenu");
        ...
        if (newLink !== undefined) {
            ...
            "inventory och toplänk ska sättas till home");
                ...
                topLink.addEventListener("click", homeView.drawHomeView);
            }
        } else {
    ...
    var showNavBar = (function (selected) {
        ...
        var navElements = [
            {name: "Home", class: "home", nav: homeView.drawHomeView},
            {name: "Order", class: "shopping_basket", nav: orderView.drawOrderView},
            {name: "Lager", class: "folder", nav: inventory.showInventory}];
    ...
    var showNavBar2 = (function (selected) {
        console.log("in menu.showNavBar and selected is " +selected);
        console.log("rensa först navigationslänkarna längst ner");
        ...
        var navElements = [
            {name: "Home", class: "home", nav: homeView.drawHomeView},
            {name: "Order", class: "order", nav: orderView.drawOrderView},
            {name: "Lager", class: "folder", nav: inventory.showInventory}];
